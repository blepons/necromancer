...
// template <class T, class Allocator>
// class matrix<T, Allocator>::const_row {
// public:
//     using const_iterator = const_pointer;
//     using const_reverse_iterator = std::reverse_iterator<const_iterator>;

//     const_row(const matrix& mx, size_type r) : matrix_(mx), row_(r) {}

//     const_row(const const_row& other) noexcept = default;

//     const_row& operator=(const const_row& other) noexcept = default;
...
//     const_reference at(size_type n) const {
//         if (n >= size()) {
//             throw std::out_of_range("matrix::const_row::at: n >= size()");
//         }
//         return matrix_(row_, n);
//     }
...
//     void swap(const_row& other) noexcept {
//         std::swap(matrix_, other.matrix_);
//         std::swap(row_, other.row_);
//     }

// private:
//     std::reference_wrapper<const matrix> matrix_;
//     size_type row_;
// };
